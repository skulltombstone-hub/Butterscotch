/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.36 on Thu Jul  2 22:44:49 2026.
    ...
    Commandline:
        --profile="compatibility" --api="gl=4.1,gles2=3.0" --generator="c" --spec="gl" --extensions="GL_ARB_debug_output,GL_ARB_framebuffer_object,GL_ARB_vertex_array_object,GL_EXT_framebuffer_blit,GL_EXT_framebuffer_object,GL_KHR_debug,GL_OES_vertex_array_object"
    Online:
